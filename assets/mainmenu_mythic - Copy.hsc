...
(script static void chest_camera_wide
	(print "helmet camera")
	(if (= currentCharacter 0)
			(camera_set "spartan_chest_wide" 10)
	)
	(if (= currentCharacter 1)
			(camera_set "elite_chest_wide" 10)
	)
)

(script static void chest_camera_standard
	(print "helmet camera")
	(if (= currentCharacter 0)
			(camera_set "spartan_chest_standard" 10)
	)
	(if (= currentCharacter 1)
			(camera_set "elite_chest_standard" 10)
	)
)
...
(script static void helmet_camera_wide
	(print "helmet camera")
	(if (= currentCharacter 0)
			(camera_set "spartan_helmet_wide" 10)
	)
	(if (= currentCharacter 1)
			(camera_set "elite_head_wide" 10)
	)
)
...
(script static void helmet_camera_standard
	(print "helmet camera")
	(if (= currentCharacter 0)
			(camera_set "spartan_helmet_standard" 10)
	)
	(if (= currentCharacter 1)
			(camera_set "elite_head_standard" 10)
	)
)
...
(script static void leftshoulder_camera_wide
	(print "body camera")
	(if (= currentCharacter 0)
			(camera_set "spartan_leftshoulder_wide" 10)
	)
	(if (= currentCharacter 1)
			(camera_set "elite_leftshoulder_wide" 10)
	)
)
...
(script static void leftshoulder_camera_standard
	(print "body camera")
	(if (= currentCharacter 0)
			(camera_set "spartan_leftshoulder_standard" 10)
	)
	(if (= currentCharacter 1)
			(camera_set "elite_leftshoulder_standard" 10)
	)
)
...
(script static void rightshoulder_camera_wide
	(print "body camera")
	(if (= currentCharacter 0)
			(camera_set "spartan_rightshoulder_wide" 10)
	)
	(if (= currentCharacter 1)
			(camera_set "elite_rightshoulder_wide" 10)
	)
)
...
(script static void rightshoulder_camera_standard
	(print "body camera")
	(if (= currentCharacter 0)
			(camera_set "spartan_rightshoulder_standard" 10)
	)
	(if (= currentCharacter 1)
			(camera_set "elite_rightshoulder_standard" 10)
	)
)

(script static void leftarm_camera_wide
	(print "body camera")
	(if (= currentCharacter 0)
			(camera_set "spartan_leftarm_wide" 10)
	)
	(if (= currentCharacter 1)
			(camera_set "elite_leftforearm_wide" 10)
	)
)

(script static void leftarm_camera_standard
	(print "body camera")
	(if (= currentCharacter 0)
			(camera_set "spartan_leftarm_standard" 10)
	)
	(if (= currentCharacter 1)
			(camera_set "elite_leftforearm_standard" 10)
	)
)

(script static void rightarm_camera_wide
	(print "body camera")
	(if (= currentCharacter 0)
			(camera_set "spartan_rightarm_wide" 10)
	)
	(if (= currentCharacter 1)
			(camera_set "elite_rightforearm_wide" 10)
	)
)

(script static void rightarm_camera_standard
	(print "body camera")
	(if (= currentCharacter 0)
			(camera_set "spartan_rightarm_standard" 10)
	)
	(if (= currentCharacter 1)
			(camera_set "elite_rightforearm_standard" 10)
	)
)

(script static void legs_camera_wide
	(print "body camera")
	(if (= currentCharacter 0)
			(camera_set "spartan_legs_wide" 10)
	)
	(if (= currentCharacter 1)
			(camera_set "elite_legs_wide" 10)
	)
)

(script static void legs_camera_standard
	(print "body camera")
	(if (= currentCharacter 0)
			(camera_set "spartan_legs_standard" 10)
	)
	(if (= currentCharacter 1)
			(camera_set "elite_legs_standard" 10)
	)
)

(script static void effects_camera_wide
	(print "body camera")
	(if (= currentCharacter 0)
			(camera_set "spartan_effects_wide" 10)
	)
)

(script static void effects_camera_standard
	(print "body camera")
	(if (= currentCharacter 0)
			(camera_set "spartan_effects_standard" 10)
	)
)
...
(script static void backpack_camera_wide
	...
	(if (= currentCharacter 0)
			(camera_set "spartan_backpack_wide" 10)
	)
	(if (= currentCharacter 1)
			(camera_set "elite_back_wide" 10)
	)
)
...
(script static void backpack_camera_standard
	(print "leftshoulder camera")
	(if (= currentCharacter 0)
			(camera_set "spartan_backpack_standard" 10)
	)
	(if (= currentCharacter 1)
			(camera_set "elite_back_standard" 10)
	)
)
...
(script static void waist_camera_wide
	(print "waist camera")
	(if (= currentCharacter 1)
			(camera_set "elite_waist_wide" 10)
	)
)
...
(script static void waist_camera_standard
	(print "waist camera")
	(if (= currentCharacter 1)
			(camera_set "elite_waist_standard" 10)
	)
)

(script static void armsflair_camera_wide
	(print "waist camera")
	(if (= currentCharacter 1)
			(camera_set "elite_armsflair_wide" 10)
	)
)

(script static void armsflair_camera_standard
	(print "armsflair camera")
	(if (= currentCharacter 1)
			(camera_set "elite_armsflair_standard" 10)
	)
)

(script static void shouldersflair_camera_wide
	(print "shouldersflair camera")
	(if (= currentCharacter 1)
			(camera_set "elite_shouldersflair_wide" 10)
	)
)

(script static void shouldersflair_camera_standard
	(print "shouldersflair camera")
	(if (= currentCharacter 1)
			(camera_set "elite_shouldersflair_standard" 10)
	)
)

(script static void thighsflair_camera_wide
	(print "thighsflair camera")
	(if (= currentCharacter 1)
			(camera_set "elite_thighsflair_wide" 10)
	)
)

(script static void thighsflair_camera_standard
	(print "thighsflair camera")
	(if (= currentCharacter 1)
			(camera_set "elite_thighsflair_standard" 10)
	)
)

(script static void exit_subcamera
	(print "exit subcamera")
	(camera_set "settings_cam" 10)
)